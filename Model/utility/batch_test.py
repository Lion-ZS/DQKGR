...
from utility.loader_dqkgr import DQKGR_loader
...
if args.model_type in ['dqkgr']:
    data_generator = DQKGR_loader(args=args, path=args.data_path + args.dataset)
