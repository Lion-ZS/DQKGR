...
def load_pretrained_data(args):
    ...
    try:
        ...
        print('load the pretrained dqkgr model parameters.')
    except Exception:
        print(
    ...
    for reg1 in [0.1]:
        ...
        for reg2 in [1e-4]:
            ...
            *********************************************************
            ...
            """
            if args.model_type in ['dqkgr']:
                model = DQKGR(data_config=config,
            ...
            *********************************************************
            ...
            for epoch in range(args.epoch):
                ...
                if epoch == 0:
                    print("Total batch number of DQKGR recommender: ", n_batch)
                """
                *********************************************************
                Alternative Training for DQKGR:
                ...
                *********************************************************
                ...
                if ret['recall'][3] == cur_best_pre_0 and args.save_flag == 1:
                    ...
                    print('Saved the .npz weights of dqkgr in path: ', temp_save_path)
